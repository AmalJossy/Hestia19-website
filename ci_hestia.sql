...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2019 at 09:28 AM
...
--
ALTER TABLE `events`
  MODIFY `event_id` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
